...
print(cp.list_variables('save/NoLeverageEMDBDPd10nbNeur20nbHL2ndt10eta50BSDE_2'))
...
print(cp.load_variable('save/NoLeverageEMDBDPd10nbNeur20nbHL2ndt10eta50BSDE_2','NetWorkUZ2/enc_fc1/weights'))
print(cp.load_variable('saved_parameters/FNL_EMDBDP_10/BoundedFNLEMDBDPd10nbNeur20nbHL2ndt120Alpha100BSDE_1','NetWorkUZ1/enc_fc1/weights'))
