...
print("PDE No Leverage EMDBDP  Dim ", d, " layerSize ", layerSize, " rescal ", rescal, "T ", T, "batchsize ", batchSize,
...
for indt in ndt:
    ...
    print("NBSTEP", indt)
    # create graph
    resol = solv.PDEFNLSolveSimpleLSExp(model, T, indt, theNetwork, initialLearningRateLast=initialLearningRateLast,
                                        initialLearningRateNoLast=initialLearningRateNoLast)
