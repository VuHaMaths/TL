...
# Feed forward classical, Havu: uses the newly created class
class FeedForwardUZDZ(FeedForwardBase):
    ...
    def getBackWeightAndBias(self,iStep, name_of_scope: str = "NetWorkUZ"):
        Weights = []
        Bias = []
