...
# Havu: this pair uses Monge Ampere equation
...
# Havu: if there are parameters from different time steps saved in the ckpt-file, we use parameters of the last step,
# i.e. step 1
weights_step = 1
